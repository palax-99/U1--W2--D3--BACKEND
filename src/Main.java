...
public class Main {
    public static void main(String[] args) {
        ...
        Product p3 = new Product(3L, "Clean Code", "Books", 245.0);
        ...
        // prodotti2.add(p3);
        //prodotti2.add(p1);
        List<Product> listBooks = prodotti.stream().filter(product -> product.getCategory().equals("Books") && product.getPrice() > 100).toList();
